...
export const QUERY_KEYS = {
  ...
  stockNewsAnalysis: (ticker: string) => ["stocks", ticker, "news-analysis"] as const,
  stockSocialAnalysis: (ticker: string) => ["stocks", ticker, "social-analysis"] as const,
  stockMacroAnalysis: (ticker: string) => ["stocks", ticker, "macro-analysis"] as const,
  ...
  stockFinancialStatements: (ticker: string) => ["stocks", ticker, "financial-statements"] as const,
  stockInsiderTransactions: (ticker: string) => ["stocks", ticker, "insider-transactions"] as const,
  stockInstitutionalHolders: (ticker: string) => ["stocks", ticker, "institutional-holders"] as const,
  stockAnalystRatings: (ticker: string) => ["stocks", ticker, "analyst-ratings"] as const,
  stockDividends: (ticker: string) => ["stocks", ticker, "dividends"] as const,
